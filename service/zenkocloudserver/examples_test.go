...
func ExampleZenkoCloudserver_AbortMultipartUpload_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.AbortMultipartUploadInput{
	...
	if err != nil {
		if aerr, ok := err.(awserr.Error); ok {
			switch aerr.Code() {
			case zenkocloudserver.ErrCodeNoSuchUpload:
				fmt.Println(zenkocloudserver.ErrCodeNoSuchUpload, aerr.Error())
			default:
...
func ExampleZenkoCloudserver_CompleteMultipartUpload_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.CompleteMultipartUploadInput{
		Bucket: aws.String("examplebucket"),
		Key:    aws.String("bigobject"),
		MultipartUpload: &zenkocloudserver.CompletedMultipartUpload{
			Parts: []*zenkocloudserver.CompletedPart{
				{
...
func ExampleZenkoCloudserver_CopyObject_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.CopyObjectInput{
	...
	if err != nil {
		if aerr, ok := err.(awserr.Error); ok {
			switch aerr.Code() {
			case zenkocloudserver.ErrCodeObjectNotInActiveTierError:
				fmt.Println(zenkocloudserver.ErrCodeObjectNotInActiveTierError, aerr.Error())
			default:
				fmt.Println(aerr.Error())
			}
		} else {
...
func ExampleZenkoCloudserver_CreateBucket_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.CreateBucketInput{
		Bucket: aws.String("examplebucket"),
		CreateBucketConfiguration: &zenkocloudserver.CreateBucketConfiguration{
	...
	if err != nil {
		if aerr, ok := err.(awserr.Error); ok {
			switch aerr.Code() {
			case zenkocloudserver.ErrCodeBucketAlreadyExists:
				fmt.Println(zenkocloudserver.ErrCodeBucketAlreadyExists, aerr.Error())
			case zenkocloudserver.ErrCodeBucketAlreadyOwnedByYou:
				fmt.Println(zenkocloudserver.ErrCodeBucketAlreadyOwnedByYou, aerr.Error())
			default:
				fmt.Println(aerr.Error())
			}
		} else {
...
func ExampleZenkoCloudserver_CreateBucket_shared01() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.CreateBucketInput{
		Bucket: aws.String("examplebucket"),
	}
...
func ExampleZenkoCloudserver_CreateMultipartUpload_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.CreateMultipartUploadInput{
		Bucket: aws.String("examplebucket"),
...
func ExampleZenkoCloudserver_DeleteBucket_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.DeleteBucketInput{
...
func ExampleZenkoCloudserver_DeleteBucketCors_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.DeleteBucketCorsInput{
		Bucket: aws.String("examplebucket"),
	}
...
func ExampleZenkoCloudserver_DeleteBucketLifecycle_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.DeleteBucketLifecycleInput{
		Bucket: aws.String("examplebucket"),
	}
...
func ExampleZenkoCloudserver_DeleteBucketPolicy_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.DeleteBucketPolicyInput{
		Bucket: aws.String("examplebucket"),
	}
...
func ExampleZenkoCloudserver_DeleteBucketReplication_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.DeleteBucketReplicationInput{
...
func ExampleZenkoCloudserver_DeleteBucketTagging_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.DeleteBucketTaggingInput{
		Bucket: aws.String("examplebucket"),
	}
...
func ExampleZenkoCloudserver_DeleteBucketWebsite_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.DeleteBucketWebsiteInput{
		Bucket: aws.String("examplebucket"),
	}
...
func ExampleZenkoCloudserver_DeleteObject_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.DeleteObjectInput{
		Bucket: aws.String("examplebucket"),
...
func ExampleZenkoCloudserver_DeleteObject_shared01() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.DeleteObjectInput{
		Bucket: aws.String("ExampleBucket"),
...
func ExampleZenkoCloudserver_DeleteObjectTagging_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.DeleteObjectTaggingInput{
		Bucket:    aws.String("examplebucket"),
		Key:       aws.String("HappyFace.jpg"),
...
// version.
func ExampleZenkoCloudserver_DeleteObjectTagging_shared01() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.DeleteObjectTaggingInput{
		Bucket: aws.String("examplebucket"),
		Key:    aws.String("HappyFace.jpg"),
...
func ExampleZenkoCloudserver_DeleteObjects_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.DeleteObjectsInput{
		Bucket: aws.String("examplebucket"),
		Delete: &zenkocloudserver.Delete{
			Objects: []*zenkocloudserver.ObjectIdentifier{
				{
					Key:       aws.String("HappyFace.jpg"),
...
func ExampleZenkoCloudserver_DeleteObjects_shared01() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.DeleteObjectsInput{
		Bucket: aws.String("examplebucket"),
		Delete: &zenkocloudserver.Delete{
...
// set on a bucket.
func ExampleZenkoCloudserver_GetBucketCors_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetBucketCorsInput{
		Bucket: aws.String("examplebucket"),
	}
...
func ExampleZenkoCloudserver_GetBucketLifecycle_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetBucketLifecycleInput{
...
func ExampleZenkoCloudserver_GetBucketLifecycleConfiguration_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetBucketLifecycleConfigurationInput{
		Bucket: aws.String("examplebucket"),
	}
...
func ExampleZenkoCloudserver_GetBucketLocation_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetBucketLocationInput{
		Bucket: aws.String("examplebucket"),
	}
...
func ExampleZenkoCloudserver_GetBucketNotification_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetBucketNotificationInput{
		Bucket: aws.String("examplebucket"),
	}
...
//
// The following example returns notification configuration set on a bucket.
func ExampleZenkoCloudserver_GetBucketNotification_shared01() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetBucketNotificationInput{
		Bucket: aws.String("examplebucket"),
	}
...
func ExampleZenkoCloudserver_GetBucketPolicy_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetBucketPolicyInput{
		Bucket: aws.String("examplebucket"),
	}
...
func ExampleZenkoCloudserver_GetBucketReplication_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetBucketReplicationInput{
		Bucket: aws.String("examplebucket"),
	}
...
func ExampleZenkoCloudserver_GetBucketRequestPayment_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetBucketRequestPaymentInput{
		Bucket: aws.String("examplebucket"),
	}
...
func ExampleZenkoCloudserver_GetBucketTagging_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetBucketTaggingInput{
		Bucket: aws.String("examplebucket"),
	}
...
//
// The following example retrieves bucket versioning configuration.
func ExampleZenkoCloudserver_GetBucketVersioning_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetBucketVersioningInput{
		Bucket: aws.String("examplebucket"),
	}
...
func ExampleZenkoCloudserver_GetBucketWebsite_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetBucketWebsiteInput{
		Bucket: aws.String("examplebucket"),
	}
...
func ExampleZenkoCloudserver_GetObject_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetObjectInput{
		Bucket: aws.String("examplebucket"),
		Key:    aws.String("HappyFace.jpg"),
	}
	...
	if err != nil {
		if aerr, ok := err.(awserr.Error); ok {
			switch aerr.Code() {
			case zenkocloudserver.ErrCodeNoSuchKey:
				fmt.Println(zenkocloudserver.ErrCodeNoSuchKey, aerr.Error())
			default:
				fmt.Println(aerr.Error())
			}
		} else {
...
func ExampleZenkoCloudserver_GetObject_shared01() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetObjectInput{
		Bucket: aws.String("examplebucket"),
...
func ExampleZenkoCloudserver_GetObjectAcl_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetObjectAclInput{
		Bucket: aws.String("examplebucket"),
		Key:    aws.String("HappyFace.jpg"),
	}
...
func ExampleZenkoCloudserver_GetObjectTagging_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetObjectTaggingInput{
		Bucket: aws.String("examplebucket"),
		Key:    aws.String("HappyFace.jpg"),
	}
...
// version.
func ExampleZenkoCloudserver_GetObjectTagging_shared01() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetObjectTaggingInput{
		Bucket:    aws.String("examplebucket"),
...
func ExampleZenkoCloudserver_GetObjectTorrent_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.GetObjectTorrentInput{
		Bucket: aws.String("examplebucket"),
		Key:    aws.String("HappyFace.jpg"),
	}
...
func ExampleZenkoCloudserver_HeadBucket_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.HeadBucketInput{
		Bucket: aws.String("acl1"),
	}
	...
	if err != nil {
		if aerr, ok := err.(awserr.Error); ok {
			switch aerr.Code() {
			case zenkocloudserver.ErrCodeNoSuchBucket:
				fmt.Println(zenkocloudserver.ErrCodeNoSuchBucket, aerr.Error())
			default:
				fmt.Println(aerr.Error())
			}
		} else {
...
func ExampleZenkoCloudserver_HeadObject_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.HeadObjectInput{
		Bucket: aws.String("examplebucket"),
		Key:    aws.String("HappyFace.jpg"),
	}
...
func ExampleZenkoCloudserver_ListBuckets_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.ListBucketsInput{}
...
func ExampleZenkoCloudserver_ListMultipartUploads_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.ListMultipartUploadsInput{
		Bucket: aws.String("examplebucket"),
	}
...
func ExampleZenkoCloudserver_ListMultipartUploads_shared01() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.ListMultipartUploadsInput{
		Bucket:         aws.String("examplebucket"),
...
// two object version, S3 returns NextToken in the response. You can specify this token
// value in your next request to fetch next set of object versions.
func ExampleZenkoCloudserver_ListObjectVersions_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.ListObjectVersionsInput{
		Bucket: aws.String("examplebucket"),
...
func ExampleZenkoCloudserver_ListObjects_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.ListObjectsInput{
		Bucket:  aws.String("examplebucket"),
		MaxKeys: aws.Int64(2),
	}
...
func ExampleZenkoCloudserver_ListObjectsV2_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.ListObjectsV2Input{
		Bucket:  aws.String("examplebucket"),
		MaxKeys: aws.Int64(2),
	}
...
func ExampleZenkoCloudserver_ListParts_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.ListPartsInput{
		Bucket:   aws.String("examplebucket"),
		Key:      aws.String("bigobject"),
...
func ExampleZenkoCloudserver_PutBucketAcl_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutBucketAclInput{
		Bucket:           aws.String("examplebucket"),
...
func ExampleZenkoCloudserver_PutBucketCors_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutBucketCorsInput{
		Bucket: aws.String(""),
		CORSConfiguration: &zenkocloudserver.CORSConfiguration{
			CORSRules: []*zenkocloudserver.CORSRule{
				{
...
// bucket.
func ExampleZenkoCloudserver_PutBucketLifecycleConfiguration_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutBucketLifecycleConfigurationInput{
		Bucket: aws.String("examplebucket"),
		LifecycleConfiguration: &zenkocloudserver.BucketLifecycleConfiguration{
			Rules: []*zenkocloudserver.LifecycleRule{
				{
					Expiration: &zenkocloudserver.LifecycleExpiration{
						Days: aws.Int64(3650),
					},
					Filter: &zenkocloudserver.LifecycleRuleFilter{
						Prefix: aws.String("documents/"),
					},
					ID:     aws.String("TestOnly"),
					Status: aws.String("Enabled"),
					Transitions: []*zenkocloudserver.Transition{
						{
							Days:         aws.Int64(365),
...
func ExampleZenkoCloudserver_PutBucketLogging_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutBucketLoggingInput{
		Bucket: aws.String("sourcebucket"),
		BucketLoggingStatus: &zenkocloudserver.BucketLoggingStatus{
			LoggingEnabled: &zenkocloudserver.LoggingEnabled{
				TargetBucket: aws.String("targetbucket"),
				TargetGrants: []*zenkocloudserver.TargetGrant{
					{
						Grantee: &zenkocloudserver.Grantee{
...
func ExampleZenkoCloudserver_PutBucketNotificationConfiguration_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutBucketNotificationConfigurationInput{
		Bucket: aws.String("examplebucket"),
		NotificationConfiguration: &zenkocloudserver.NotificationConfiguration{
			TopicConfigurations: []*zenkocloudserver.TopicConfiguration{
				{
					Events: []*string{
...
func ExampleZenkoCloudserver_PutBucketPolicy_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutBucketPolicyInput{
		Bucket: aws.String("examplebucket"),
...
func ExampleZenkoCloudserver_PutBucketReplication_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutBucketReplicationInput{
		Bucket: aws.String("examplebucket"),
		ReplicationConfiguration: &zenkocloudserver.ReplicationConfiguration{
			Role: aws.String("arn:aws:iam::123456789012:role/examplerole"),
			Rules: []*zenkocloudserver.ReplicationRule{
				{
					Destination: &zenkocloudserver.Destination{
...
func ExampleZenkoCloudserver_PutBucketRequestPayment_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutBucketRequestPaymentInput{
		Bucket: aws.String("examplebucket"),
		RequestPaymentConfiguration: &zenkocloudserver.RequestPaymentConfiguration{
...
func ExampleZenkoCloudserver_PutBucketTagging_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutBucketTaggingInput{
		Bucket: aws.String("examplebucket"),
		Tagging: &zenkocloudserver.Tagging{
			TagSet: []*zenkocloudserver.Tag{
				{
					Key:   aws.String("Key1"),
...
func ExampleZenkoCloudserver_PutBucketVersioning_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutBucketVersioningInput{
		Bucket: aws.String("examplebucket"),
		VersioningConfiguration: &zenkocloudserver.VersioningConfiguration{
...
func ExampleZenkoCloudserver_PutBucketWebsite_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutBucketWebsiteInput{
		Bucket:     aws.String("examplebucket"),
		ContentMD5: aws.String(""),
		WebsiteConfiguration: &zenkocloudserver.WebsiteConfiguration{
			ErrorDocument: &zenkocloudserver.ErrorDocument{
				Key: aws.String("error.html"),
			},
			IndexDocument: &zenkocloudserver.IndexDocument{
...
func ExampleZenkoCloudserver_PutObject_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutObjectInput{
...
func ExampleZenkoCloudserver_PutObject_shared01() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutObjectInput{
...
func ExampleZenkoCloudserver_PutObject_shared02() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutObjectInput{
...
// object.
func ExampleZenkoCloudserver_PutObject_shared03() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutObjectInput{
		Body:   aws.ReadSeekCloser(strings.NewReader("HappyFace.jpg")),
		Bucket: aws.String("examplebucket"),
...
func ExampleZenkoCloudserver_PutObject_shared04() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutObjectInput{
		Body:   aws.ReadSeekCloser(strings.NewReader("filetoupload")),
		Bucket: aws.String("examplebucket"),
...
func ExampleZenkoCloudserver_PutObject_shared05() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutObjectInput{
...
func ExampleZenkoCloudserver_PutObject_shared06() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutObjectInput{
		Body:                 aws.ReadSeekCloser(strings.NewReader("filetoupload")),
		Bucket:               aws.String("examplebucket"),
...
func ExampleZenkoCloudserver_PutObjectAcl_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutObjectAclInput{
		AccessControlPolicy: &zenkocloudserver.AccessControlPolicy{},
		Bucket:              aws.String("examplebucket"),
...
func ExampleZenkoCloudserver_PutObjectTagging_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.PutObjectTaggingInput{
		Bucket: aws.String("examplebucket"),
		Key:    aws.String("HappyFace.jpg"),
		Tagging: &zenkocloudserver.Tagging{
			TagSet: []*zenkocloudserver.Tag{
...
// Amazon S3 bucket.
func ExampleZenkoCloudserver_RestoreObject_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.RestoreObjectInput{
		Bucket: aws.String("examplebucket"),
		Key:    aws.String("archivedobjectkey"),
		RestoreRequest: &zenkocloudserver.RestoreRequest{
			Days: aws.Int64(1),
			GlacierJobParameters: &zenkocloudserver.GlacierJobParameters{
	...
	if err != nil {
		if aerr, ok := err.(awserr.Error); ok {
			switch aerr.Code() {
			case zenkocloudserver.ErrCodeObjectAlreadyInActiveTierError:
				fmt.Println(zenkocloudserver.ErrCodeObjectAlreadyInActiveTierError, aerr.Error())
			default:
				fmt.Println(aerr.Error())
			}
		} else {
...
// multipart upload.
func ExampleZenkoCloudserver_UploadPart_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.UploadPartInput{
		Body:       aws.ReadSeekCloser(strings.NewReader("fileToUpload")),
		Bucket:     aws.String("examplebucket"),
...
func ExampleZenkoCloudserver_UploadPartCopy_shared00() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.UploadPartCopyInput{
		Bucket:     aws.String("examplebucket"),
...
func ExampleZenkoCloudserver_UploadPartCopy_shared01() {
	svc := zenkocloudserver.New(session.New())
	input := &zenkocloudserver.UploadPartCopyInput{
		Bucket:          aws.String("examplebucket"),
		CopySource:      aws.String("/bucketname/sourceobjectkey"),
